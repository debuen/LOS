    ...
    <body>
        ...
        <div class="container-fluid" style="width: 100%; height: 100%; font-size: 15px; padding-top: 100px;">
            <ul class="nav nav-tabs nav-justified" style="padding-left: 65px; display: block;">
                <li role="presentation" class="active"><a href="#" style="background-color: transparent;">Actual Fixture</a></li>
                <li role="presentation" ><a href="#" style="background-color: #cccccc;">All Fixtures</a></li>
            </ul>
