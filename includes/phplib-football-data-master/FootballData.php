...
//include FOOTBALL_DATA_DIR.'./models/Soccerseason.php';
//include FOOTBALL_DATA_DIR.'./models/Team.php';

include '../includes/phplib-football-data-master/models/Soccerseason.php';
include '../includes/phplib-football-data-master/models/Team.php';
...
class FootballData {
    ...
    public function __construct() {
        $this->config = parse_ini_file("../includes/phplib-football-data-master/config.ini", true);
    ...
    public function getSoccerSeasonsByYear($year) {
    		// competitions/?season=2018
        $resource = 'competitions/?season=' . $year;
    ...
    public function getFixturesBySeasonID($id) {
        $resource = 'competitions/'.$id.'/fixtures/';
        $response = file_get_contents($this->baseUri.$resource, false, stream_context_create($this->reqPrefs));
